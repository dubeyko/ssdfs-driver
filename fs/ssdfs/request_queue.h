...
enum {
	...
	SSDFS_READ_DESTROY_PEB,			/* 0x0D */
	SSDFS_READ_CMD_MAX,			/* 0x0E */
	SSDFS_CREATE_BLOCK,			/* 0x0F */
	SSDFS_CREATE_EXTENT,			/* 0x10 */
	SSDFS_CREATE_CMD_MAX,			/* 0x11 */
	SSDFS_UPDATE_BLOCK,			/* 0x12 */
	SSDFS_UPDATE_PRE_ALLOC_BLOCK,		/* 0x13 */
	SSDFS_UPDATE_EXTENT,			/* 0x14 */
	SSDFS_UPDATE_PRE_ALLOC_EXTENT,		/* 0x15 */
	SSDFS_COMMIT_LOG_NOW,			/* 0x16 */
	SSDFS_START_MIGRATION_NOW,		/* 0x17 */
	SSDFS_EXTENT_WAS_INVALIDATED,		/* 0x18 */
	SSDFS_FLUSH_DESTROY_PEB,		/* 0x19 */
	SSDFS_UPDATE_CMD_MAX,			/* 0x1A */
	SSDFS_BTREE_NODE_DIFF,			/* 0x1B */
	SSDFS_USER_DATA_DIFF,			/* 0x1C */
	SSDFS_DIFF_ON_WRITE_MAX,		/* 0x1D */
	SSDFS_COPY_PAGE,			/* 0x1E */
	SSDFS_COPY_PRE_ALLOC_PAGE,		/* 0x1F */
	SSDFS_MIGRATE_RANGE,			/* 0x20 */
	SSDFS_MIGRATE_PRE_ALLOC_PAGE,		/* 0x21 */
	SSDFS_MIGRATE_FRAGMENT,			/* 0x22 */
	SSDFS_COLLECT_GARBAGE_CMD_MAX,		/* 0x23 */
	SSDFS_KNOWN_CMD_MAX,			/* 0x24 */
};
