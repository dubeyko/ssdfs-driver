...
enum {
	...
	SSDFS_MIGRATE_ZONE_USER_BLOCK,		/* 0x10 */
	SSDFS_MIGRATE_ZONE_USER_EXTENT,		/* 0x11 */
	SSDFS_CREATE_CMD_MAX,			/* 0x12 */
	SSDFS_UPDATE_BLOCK,			/* 0x13 */
	SSDFS_UPDATE_PRE_ALLOC_BLOCK,		/* 0x14 */
	SSDFS_UPDATE_EXTENT,			/* 0x15 */
	SSDFS_UPDATE_PRE_ALLOC_EXTENT,		/* 0x16 */
	SSDFS_COMMIT_LOG_NOW,			/* 0x17 */
	SSDFS_START_MIGRATION_NOW,		/* 0x18 */
	SSDFS_EXTENT_WAS_INVALIDATED,		/* 0x19 */
