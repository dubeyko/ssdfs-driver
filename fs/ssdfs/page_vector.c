...
atomic64_t ssdfs_page_vector_folio_leaks;
...
void ssdfs_page_vector_memory_leaks_init(void)
{
	...
	atomic64_set(&ssdfs_page_vector_folio_leaks, 0);
...
void ssdfs_page_vector_check_memory_leaks(void)
{
	...
	if (atomic64_read(&ssdfs_page_vector_folio_leaks) != 0) {
		SSDFS_ERR("PAGE VECTOR: "
			  "memory leaks include %lld folios\n",
			  atomic64_read(&ssdfs_page_vector_folio_leaks));
	}
