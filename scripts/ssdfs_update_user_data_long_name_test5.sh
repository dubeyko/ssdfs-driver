...
dd if=./pattern2.bin of=$2/"long_12345678_name_"$i".txt" conv=notrunc seek=$l bs=4096 count=1
#dd if=./pattern1.bin of=$2/"long_12345678_name_"$i".txt" bs=4096 count=1
