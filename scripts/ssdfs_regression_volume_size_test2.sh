...
if [[ $# -lt 2 ]]
then
    echo "Usage: $0 BLOCK-DEVICE MOUNTPOINT"
    exit 1
fi
...
volume_size_min=$[1]
#volume_size_min=$[2]
volume_size_max=$[16*1024]
nsegs_max=150000000
min_segs=40
min_logical_blks_per_peb=8
max_logical_blks_per_peb=$[65536-1]
volume_1gb_factor=$[1]
volume_10gb_factor=$[10]
volume_100gb_factor=$[100]
volume_size_1gb_threshold=$[100]
volume_size_10gb_threshold=$[1024]
...
do
  ...
  do
    ...
    do
      ...
      nsegs=$[$volume_size_bytes/$seg_size]
      ...
      echo "volume_size: $volume_size_bytes (peb_size: $peb_size, pebs_per_seg: $pebs_per_seg)"
      ...
      do
        ...
        echo "CREATE: volume_size: $volume_size_bytes (page_size: ${block_size[$i]}, peb_size: $peb_size, pebs_per_seg: $pebs_per_seg)"

        parted -s $block_device mkpart primary 0GB $volume_size"GB" --align optimal  || exit 1
        ...
        partition=$block_device"1"

        echo "Format $image ..."
        mkfs.ssdfs -p ${block_size[$i]} -e $peb_size -s $seg_size -L ssdfs-test $partition || exit 1

        echo "Start testing ..."
        ./ssdfs_add_user_data_test4.sh $partition $mount_point 0 10 1000 16384
        ./ssdfs_read_md5_user_data.sh $partition $mount_point 0 10 1000
        ./ssdfs_update_user_data_test5.sh $partition $mount_point 0 10 1000 16384
        ./ssdfs_delete_file_test2.sh $partition $mount_point 0 10 1000

#        folder_name=${block_size[$j]}"-"$peb_size"-"$seg_size"-"$k"-MOUNT-DUMP-0001"
#        mkdir $folder_name
...
#        cd ../
        ...
        echo "Start testing ..."
        ./ssdfs_add_user_data_test4.sh $partition $mount_point 0 100 1000 16384
        ./ssdfs_read_md5_user_data.sh $partition $mount_point 0 100 1000
        ./ssdfs_update_user_data_test5.sh $partition $mount_point 0 100 1000 16384
        ./ssdfs_delete_file_test2.sh $partition $mount_point 0 100 1000

#        folder_name=${block_size[$j]}"-"$peb_size"-"$seg_size"-"$k"-MOUNT-DUMP-0002"
#        mkdir $folder_name
#        chown -hR slavad $folder_name
#        cd $folder_name
#        dump.ssdfs -p parse_all,raw_dump -o ./ $1
#        cd ../
        ...
        echo "Start testing ..."
        ./ssdfs_add_user_data_test4.sh $partition $mount_point 0 1000 1000 16384
        ./ssdfs_read_md5_user_data.sh $partition $mount_point 0 1000 1000
...
#        folder_name=${block_size[$j]}"-"$peb_size"-"$seg_size"-"$k"-MOUNT-DUMP-0003"
#        mkdir $folder_name
#        chown -hR slavad $folder_name
#        cd $folder_name
#        dump.ssdfs -p parse_all,raw_dump -o ./ $1
#        cd ../
        ...
        echo "Start testing ..."
        ./ssdfs_add_user_data_test4.sh $partition $mount_point 0 10 1000 102400
        ./ssdfs_read_md5_user_data.sh $partition $mount_point 0 10 1000
        ./ssdfs_update_user_data_test5.sh $partition $mount_point 0 10 1000 102400
        ./ssdfs_delete_file_test2.sh $partition $mount_point 0 10 1000

#        folder_name=${block_size[$j]}"-"$peb_size"-"$seg_size"-"$k"-MOUNT-DUMP-0004"
#        mkdir $folder_name
#        chown -hR slavad $folder_name
#        cd $folder_name
#        dump.ssdfs -p parse_all,raw_dump -o ./ $1
#        cd ../
        ...
        echo "Start testing ..."
        ./ssdfs_add_user_data_test4.sh $partition $mount_point 0 100 1000 102400
        ./ssdfs_read_md5_user_data.sh $partition $mount_point 0 100 1000
        ./ssdfs_update_user_data_test5.sh $partition $mount_point 0 100 1000 102400
        ./ssdfs_delete_file_test2.sh $partition $mount_point 0 100 1000

#        folder_name=${block_size[$j]}"-"$peb_size"-"$seg_size"-"$k"-MOUNT-DUMP-0005"
#        mkdir $folder_name
#        chown -hR slavad $folder_name
#        cd $folder_name
#        dump.ssdfs -p parse_all,raw_dump -o ./ $1
#        cd ../
        ...
        echo "Start testing ..."
        ./ssdfs_add_user_data_test4.sh $partition $mount_point 0 1000 1000 102400
        ./ssdfs_read_md5_user_data.sh $partition $mount_point 0 1000 1000
        ./ssdfs_update_user_data_test5.sh $partition $mount_point 0 1000 1000 102400
        ./ssdfs_delete_file_test2.sh $partition $mount_point 0 1000 1000

#        folder_name=${block_size[$j]}"-"$peb_size"-"$seg_size"-"$k"-MOUNT-DUMP-0006"
#        mkdir $folder_name
#        chown -hR slavad $folder_name
#        cd $folder_name
#        dump.ssdfs -p parse_all,raw_dump -o ./ $1
